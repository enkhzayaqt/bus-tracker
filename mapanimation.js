...
// marker for first coordinates in the array busStops.
...
let counter = 0;
function move() {
  // marker moves on the map every 1000ms. Use the function marker.setLngLat() to update the marker coordinates
  setTimeout(() => {
